...
[![Test](https://img.shields.io/github/actions/workflow/status/arampatzis/randex/test-and-coverage.yml?branch=main)](https://github.com/arampatzis/randex/actions/workflows/test-and-coverage.yml)
